...
write.table(static_sensor_placed, file = "./sensorLocations/static_sensor_locations1.csv",row.names=FALSE, col.names=FALSE, sep=",")
write.table(mobile_sensor_placed, file = "./sensorLocations/mobile_sensor_locations1.csv",row.names=FALSE, col.names=FALSE, sep=",")
write.table(mobile_number_deployed, file = "./sensorLocations/mobile_number_deployed1.csv",row.names=FALSE, col.names=FALSE, sep=",")
