import richmond_leak_parse_script
import epanet_call
from random import randint
import math
import numpy as np
from epanet_call import epanet_call
from richmond_leak_parse_script import parse_input,parse_output,isConnected,leakMatrixCreation,mobileMatrixCreation,flowMatrixCreation
...
# 	i=10
	print i
	emitter_line = ''
	emitter_line += str(unique_node_list[i]) + ' ' + str(700) + ' ' + str(1)
	file = open(file_path)
