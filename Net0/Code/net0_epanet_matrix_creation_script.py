import net0_leak_parse_script
import epanet_call
from random import randint
import math
import numpy as np
from epanet_call import epanet_call
from net0_leak_parse_script import parse_input,parse_output,isConnected,leakMatrixCreation,mobileMatrixCreation
...
# 	i=2
	...
	mobile_traversal_array = mobileMatrixCreation(unique_node_list[i],unique_node_list,isConnected_list)
...
# print final_mobile_deployment_matrix
...
# print(np.dot(final_mobile_deployment_matrix,final_mobile_deployment_matrix))
